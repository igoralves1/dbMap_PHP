...
para mapear a base de dados que será enviada como parâmetro do método <em><strong style="color:blue" >myDbMap::Fn_dbMap</strong>($savePath, $dsn, $username, $password, $db);</em>. Em seguida,
